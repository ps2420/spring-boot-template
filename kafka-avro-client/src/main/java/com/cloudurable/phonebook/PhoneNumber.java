...
public class PhoneNumber extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PhoneNumber\",\"namespace\":\"com.cloudurable.phonebook\",\"fields\":[{\"name\":\"areaCode\",\"type\":\"string\"},{\"name\":\"countryCode\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"prefix\",\"type\":\"string\"},{\"name\":\"number\",\"type\":\"string\"}]}");
   ...
   */
  public static com.cloudurable.phonebook.PhoneNumber.Builder newBuilder() {
    return new com.cloudurable.phonebook.PhoneNumber.Builder();
  }
   ...
   * @return A new PhoneNumber RecordBuilder
   */
  public static com.cloudurable.phonebook.PhoneNumber.Builder newBuilder(com.cloudurable.phonebook.PhoneNumber.Builder other) {
    return new com.cloudurable.phonebook.PhoneNumber.Builder(other);
  }
   ...
   * @return A new PhoneNumber RecordBuilder
   */
  public static com.cloudurable.phonebook.PhoneNumber.Builder newBuilder(com.cloudurable.phonebook.PhoneNumber other) {
    return new com.cloudurable.phonebook.PhoneNumber.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneNumber>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.cloudurable.phonebook.PhoneNumber.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.cloudurable.phonebook.PhoneNumber other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.areaCode)) {
        this.areaCode = data().deepCopy(fields()[0].schema(), other.areaCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.PhoneNumber.Builder setAreaCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.PhoneNumber.Builder clearAreaCode() {
      areaCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.PhoneNumber.Builder setCountryCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.PhoneNumber.Builder clearCountryCode() {
      countryCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.PhoneNumber.Builder setPrefix(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.PhoneNumber.Builder clearPrefix() {
      prefix = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.PhoneNumber.Builder setNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.PhoneNumber.Builder clearNumber() {
      number = null;

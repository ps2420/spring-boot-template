...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** The persons given name */
   ...
   private java.lang.CharSequence flName;
   private int age;
   private java.util.List<java.lang.CharSequence> emails;
   private com.cloudurable.phonebook.PhoneNumber phoneNumber;
   private com.cloudurable.phonebook.Status status;
   ...
   */
  public Employee(java.lang.CharSequence firstName, java.lang.CharSequence nickName, java.lang.CharSequence lastName, java.lang.CharSequence flName, java.lang.Integer age, java.util.List<java.lang.CharSequence> emails, com.cloudurable.phonebook.PhoneNumber phoneNumber, com.cloudurable.phonebook.Status status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: flName = (java.lang.CharSequence)value$; break;
    case 4: age = (java.lang.Integer)value$; break;
    case 5: emails = (java.util.List<java.lang.CharSequence>)value$; break;
    case 6: phoneNumber = (com.cloudurable.phonebook.PhoneNumber)value$; break;
    case 7: status = (com.cloudurable.phonebook.Status)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.lang.CharSequence getFlName() {
    return flName;
  }
   ...
   * @param value the value to set.
   */
  public void setFlName(java.lang.CharSequence value) {
    this.flName = value;
  }
   ...
   */
  public com.cloudurable.phonebook.PhoneNumber getPhoneNumber() {
    return phoneNumber;
  }
   ...
   * @param value the value to set.
   */
  public void setPhoneNumber(com.cloudurable.phonebook.PhoneNumber value) {
   ...
   */
  public com.cloudurable.phonebook.Status getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(com.cloudurable.phonebook.Status value) {
    this.status = value;
  }
   ...
   */
  public static com.cloudurable.phonebook.Employee.Builder newBuilder() {
    return new com.cloudurable.phonebook.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.cloudurable.phonebook.Employee.Builder newBuilder(com.cloudurable.phonebook.Employee.Builder other) {
    return new com.cloudurable.phonebook.Employee.Builder(other);
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.cloudurable.phonebook.Employee.Builder newBuilder(com.cloudurable.phonebook.Employee other) {
    return new com.cloudurable.phonebook.Employee.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
    ...
    private java.util.List<java.lang.CharSequence> emails;
    private com.cloudurable.phonebook.PhoneNumber phoneNumber;
    private com.cloudurable.phonebook.PhoneNumber.Builder phoneNumberBuilder;
    private com.cloudurable.phonebook.Status status;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.cloudurable.phonebook.Employee.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.flName)) {
        this.flName = data().deepCopy(fields()[3].schema(), other.flName);
      ...
      if (other.hasPhoneNumberBuilder()) {
        this.phoneNumberBuilder = com.cloudurable.phonebook.PhoneNumber.newBuilder(other.getPhoneNumberBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.cloudurable.phonebook.Employee other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder setNickName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder clearNickName() {
      nickName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder setFlName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder clearFlName() {
      flName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder setEmails(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder clearEmails() {
      emails = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder setPhoneNumber(com.cloudurable.phonebook.PhoneNumber value) {
     ...
     * @return This builder.
     */
    public com.cloudurable.phonebook.PhoneNumber.Builder getPhoneNumberBuilder() {
      if (phoneNumberBuilder == null) {
        if (hasPhoneNumber()) {
          setPhoneNumberBuilder(com.cloudurable.phonebook.PhoneNumber.newBuilder(phoneNumber));
        } else {
          setPhoneNumberBuilder(com.cloudurable.phonebook.PhoneNumber.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.cloudurable.phonebook.Employee.Builder setPhoneNumberBuilder(com.cloudurable.phonebook.PhoneNumber.Builder value) {
      clearPhoneNumber();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder clearPhoneNumber() {
      phoneNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder setStatus(com.cloudurable.phonebook.Status value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cloudurable.phonebook.Employee.Builder clearStatus() {
      status = null;
    ...
    public Employee build() {
      try {
        ...
        record.flName = fieldSetFlags()[3] ? this.flName : (java.lang.CharSequence) defaultValue(fields()[3]);
        ...
        if (phoneNumberBuilder != null) {
          ...
          record.phoneNumber = fieldSetFlags()[6] ? this.phoneNumber : (com.cloudurable.phonebook.PhoneNumber) defaultValue(fields()[6]);
        }
        record.status = fieldSetFlags()[7] ? this.status : (com.cloudurable.phonebook.Status) defaultValue(fields()[7]);
        return record;

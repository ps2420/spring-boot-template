...
public class SingleFieldQueryTest extends BaseSetup {

  private static final Logger LOGGER = LoggerFactory.getLogger(SingleFieldQueryTest.class);
  ...
  public void testTermAggregrationQuery() throws Exception {
    final SearchSourceBuilder searchSourceBuilder = QueryBuilder.defaultSourceBuilder(0, 0);
  ...
  public void executeESQuery() throws Exception {
    ...
    final SearchSourceBuilder sourceBuilder = QueryBuilder.defaultSourceBuilder(0, 100);
